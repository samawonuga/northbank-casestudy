...
export const INITIATIVES = [
  ...
  { n: '02', title: 'Test repeat-offer cadence and targeting', evidence: 'Test when and how often repeat offers are sent, and tailor the next offer to customer needs such as monthly payment vs total cost. View → Apply falls 31.1% → 6.7% from offer 1 to 4.', quadrant: 'Do now', group: 'reach', x: 28, y: 44 },
  { n: '03', title: 'Improve offer value & framing', evidence: 'Review APR/term economics and test tailored value framing, such as monthly payment vs total saving. Only 19.2% of viewers apply; conversion varies materially by APR, term and total-cost saving.', quadrant: 'Do now', group: 'proposition', x: 31, y: 40 },
  { n: '04', title: 'Test a minimum total-cost saving threshold', evidence: 'Review offers that lower monthly payments but increase total cost; test whether clearer value framing or pricing changes improve uptake. 38.4% fall into this group.', quadrant: 'Plan', group: 'proposition', x: 70, y: 42 },
  { n: '05', title: 'Simplify digital application experience', evidence: 'Reduce application effort by pre-filling known information and identifying the requirements causing abandonment. 60.8% complete requirements.', quadrant: 'Plan', group: 'conversion', x: 60, y: 46 },
  ...
  { n: '07', title: 'Improve settlement status guidance', evidence: 'Give customers clearer progress, next steps and expectations while settlement is being verified. Survey feedback indicates uncertainty during the settlement wait.', quadrant: 'Plan', group: 'conversion', x: 31, y: 68 },
  { n: '08', title: 'Test trust & reassurance interventions', evidence: 'Audit existing support/trust signals and test targeted in-app (or web) reassurance for hesitant customers (e.g. FAQs or contact options). Survey feedback indicates demand for human reassurance.', quadrant: 'Plan', group: 'conversion', x: 24, y: 76 },
];
